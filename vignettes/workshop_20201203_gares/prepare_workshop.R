...
# # data chrisma/.../scorefiles April 2013
# head(dat)
# unique(dat$SampleName)
# head(Rh88probe1)
# unique(Rh88probe1$sample)
#
# combscores <- read.delim("file:///W:/PROJECTS/ChrisMa/Polyploids_Rose/scorefiles April 2013/combinedscores_autoallo_Rh88_HP_20140113-151616.dat")
# combscores[1:5,1:25]
# colnames(combscores)
# rm(dat, Rh88probe1, combscores)


# write tab sep data Korea -------------------------------
load("C:/Users/tumin001/OneDrive - WageningenUR/polyploids/rose/Rose_Korea/fitPoly_noF1s_20180712/20180712-234650_scores.RData")
head(scores)
...
write.table(scores, file = "vignettes/workshop_20201203/20180712-234650_scores.dat",
...
## preview
readLines("vignettes/workshop_20201203/20180712-234650_scores.dat", 10)

scores_preview <- read.delim.ffdf(file="vignettes/workshop_20201203/20180712-234650_scores.dat",
                                  nrows = 10)
scores_preview
...
# Association study ----------
## phenotypes
phenotypes <- read.csv("C:/Users/tumin001/OneDrive - WageningenUR/polyploids/rose/Rose_Korea/gwas/dataprep/pheno_info.csv")
head(phenotypes)

phenotypes <- phenotypes[, c("Roeland_name","Flower_Width_mean")]
indnamestab
colnames(ratios)
phenotypes$anonym <- indnamestab$anonym[match(phenotypes$Roeland_name, indnamestab$orig)]
phenotypes <- phenotypes[,c(3,2)]
colnames(phenotypes) <- c("SampleName","pheno01")
phenotypes <- phenotypes[phenotypes$SampleName %in% colnames(ratios),]
phenotypes$pheno01 <- round(phenotypes$pheno01,2)
...
## quality screening functions are not included in mpQTL
...
save(data,mrksel,indsel,map,ratios,Bfreq,phenotypes,
