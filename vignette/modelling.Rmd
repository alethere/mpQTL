...
```{r}
pop <- c(rep("parents",10),rep(paste0("C",1:9),each=50))
...
However, sometimes it's not simple to decide to which population an individual belongs. An alternative method is to use the Kinship matrix and PCoA to obtain a set of factors to identify individuals. This way, an automated set of fixed factors is defined. By 
