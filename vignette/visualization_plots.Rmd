...
#second and third
pcoa.plot(K,col = pop,legpos = "bottomright",comp = c(1,3),
          pch=19,main="PCoA plot of K (similarity)")
```
...
```{r}
pcoa.plot(K,col = pop,legpos = "bottomright",comp = c(3,4),
          pch=19,main="PCoA plot of K (similarity)")
```
