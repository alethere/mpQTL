...
# Data loading ------------------------------------------------------------
phe <- readRDS("research/phenotyping/phenotypes.RDS")
gen <- data.table::fread("research/PedigreeSim/NAM_crosses/3_ancestral/cross200_genotypes.dat",
                         header = T)[,-1]
dos <- data.table::fread(
  "research/PedigreeSim/NAM_crosses/3_ancestral/cross200_alleledose.dat",
  header = T)[,-1]
anc <- link_NAM(
  "research/PedigreeSim/NAM_crosses/3_ancestral/cross200_founderalleles.dat",
  totallele = "research/PedigreeSim/Parents/Total_pop.txt",
  ploidy = 4)
