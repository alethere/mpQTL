...
- mapQTL_fun.R: functions to perform the mpQTL mapping analysis.
- power_fun.R: functions to calculate power from p-values.
- qtl_analyses.RDS: R object containing the results of the QTL analyses. Can be generated using the R
  script analysis.R.
- threshold.RDS: R object containing the thresholds calculated for the QTL analyses. Can be generated using
  the R script analysis.R.
- analysis.R: script that allows to reproduce the results presented in the article based on the data found in
  the Genotypes folder and Phenotypes.txt file. Instructions to run the analysis can be found within the script.
